...
@Database(entities = {DailyActivity.class, Task.class, CalendarEvent.class, UserProfile.class, Wallet.class, FinanceTransaction.class}, version = 3, exportSchema = false)
